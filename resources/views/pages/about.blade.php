...
@section('content')
<div class="flex flex-col items-center justify-center bg-gradient-to-br from-[#ffffff] p-8">
    <!-- Header Section -->
    <div id="header" class="text-center mb-12 opacity-0 translate-y-8 transition duration-700">
        <h1 class="text-4xl font-extrabold text-[#582c2e]">
            Tentang Kami
        </h1>
        <p class="text-lg text-[#a95656] mt-2">
            Selamat datang di Kantor Hukum Sukses & Partners!
        </p>
    </div>

    <!-- Introduction Section -->
    <div id="intro" class="max-w-4xl text-center text-[#582c2e] mb-12 opacity-0 translate-y-8 transition duration-700">
        <p>
    ...
    <!-- Visi & Misi Section -->
    <div id="visiMisi" class="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 ">
        <div class="bg-[#f5ebe0] rounded-lg shadow-lg p-6 border-t-4 border-[#582c2e] opacity-0 -translate-x-8 transition duration-700">
        ...
        <div class="bg-[#f5ebe0] rounded-lg shadow-lg p-6 border-t-4 border-[#582c2e] opacity-0 translate-x-8 transition duration-700">
            ...
            <ul class="list-disc list-inside text-[#582c2e]">
    ...
    <div class="max-w-6xl text-center bg-[#f5ebe0] rounded-lg shadow-lg p-8 border-t-4 border-[#582c2e] mb-12 opacity-0 translate-y-8 transition duration-700">
    ...
    <div class="text-center mb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Lawyer Card -->
            <div class="bg-[#f5ebe0] rounded-lg shadow-lg p-6 border-t-4 border-[#582c2e] transform transition-all duration-500 hover:scale-105 hover:bg-[#e5d5c8] hover:shadow-2xl">
                <!-- Lawyer Image -->
                <img src="image/yusril.jpg" alt="Prof. Dr. H. Yusril Ihza Mahendra" class="w-24 h-24 mx-auto  mb-4 object-cover border-2 border-[#582c2e]">
                ...
                <p class="text-sm text-[#582c2e] mt-2">
                    Spesialisasi: Hukum Tata Negara, Hukum Pidana, dan Hukum Perdata. Berpengalaman lebih dari 30 tahun.
                </p>
            </div>
            <!-- Repeat Lawyer Card for Others -->
            <div class="bg-[#f5ebe0] rounded-lg shadow-lg p-6 border-t-4 border-[#582c2e] transform transition-all duration-500 hover:scale-105 hover:bg-[#e5d5c8] hover:shadow-2xl">
                <img src="image/soesilo.jpg" alt="R. Soesilo Aribowo" class="w-24 h-24 mx-auto  mb-4 object-cover border-2 border-[#582c2e]">
            ...
            <div class="bg-[#f5ebe0] rounded-lg shadow-lg p-6 border-t-4 border-[#582c2e] transform transition-all duration-500 hover:scale-105 hover:bg-#e5d5c8] hover:shadow-2xl">
                <img src="image/lily.jpg" alt="Liliyana Widodo" class="w-24 h-24 mx-auto  mb-4 object-cover border-2 border-[#582c2e]">
            ...
            <div class="bg-[#f5ebe0] rounded-lg shadow-lg p-6 border-t-4 border-[#582c2e] transform transition-all duration-500 hover:scale-105 hover:bg-[#e5d5c8] hover:shadow-2xl">
                <img src="image/andreas.jpg" alt="Andreas Tandi" class="w-24 h-24 mx-auto  mb-4 object-cover border-2 border-[#582c2e]">
